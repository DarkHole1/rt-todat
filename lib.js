...
var subjects = [
  'архивы', 'админов', 'ARG', 'пароли', 'опалкойны', 'пейпал', 'могилы',
  'печяти', 'симулякра', 'зеркала', 'QR', 'гуглдок', 'правила', 'закрепы',
  'названия', 'опалы', 'открытки'
];

var actions2 = [
  ['взломала', 'взломал'], ['нашла', 'нашёл'], ['выгнала', 'выгнал'],
  ['удалила', 'удалил'], ['выиграла', 'выиграл'], ['зевнула', 'зевнул'],
  ['проопалесцировала', 'проопалесцировал'], ['открыла', 'открыл'],
  ['послала', 'послал'], ['забыла', 'забыл'], ['написала', 'написал']
];

var subjects2 = [
  'архив', 'админа', 'ARG', 'пароль', 'опалкойн', 'пейпал', 'могилу',
  'печять', 'симулякра', 'зеркало', 'QR', 'гуглдок', 'правила', 'закреп',
  'название', 'опал', 'открытку'
];

var char = [
  'быстро', 'медленно', 'предсказуемо', 'неожиданно', 'тупо', 'умно'
];
...
function randomEvent() {
  ...
  return randomName(gender) + ' ' + randomAction2(gender);
}

function randomAction2(gender) {
  return _.sample(char) + ' ' + _.sample(actions2)[gender] + ' ' + _.sample(subjects2);
}
